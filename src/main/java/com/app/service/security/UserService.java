...
public class UserService {
    ...
    public User createNewUser(UserInfo userInfo) {
        ...
        if(userOptional.isPresent()) {
            ...
            log.info("Updating user {}, {} {}", user.getEmailId(), userInfo.getFirstName(), userInfo.getLastName());
            return user;
        };
        ...
        val user = User.builder().emailId(userInfo.getEmailId().trim())
                ...
                .isActive(false)
                .build();
        log.info("Creating user {}, {} {}", user.getEmailId(), userInfo.getFirstName(), userInfo.getLastName());
